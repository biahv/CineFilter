...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button novoBtn = (Button) findViewById(R.id.novoBtn);
        novoBtn.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this,NovoActivity.class);
                startActivity(intent);
            }
        });

        Button esqSenhaBtn=(Button) findViewById(R.id.esqSenhaBtn);
        esqSenhaBtn.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
